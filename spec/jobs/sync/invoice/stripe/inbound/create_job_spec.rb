...
RSpec.describe Sync::Invoice::Stripe::Inbound::CreateJob, type: :job do
  ...
  let(:job) { Sync::Invoice::Stripe::Inbound::CreateJob }
  ...
  describe "#perform" do
    ...
    it "will sync if policy approves" do
      ...
      expect(Invoice).to receive(:create!).with({
        description: "description here",
  ...
  describe "#policy" do
    it "returns a policy" do
      ...
      expect(job.new(webhook_event).policy).to be_a(Sync::Invoice::Stripe::Inbound::CreatePolicy)
    end
  end
